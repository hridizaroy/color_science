...
cm_h_offset = 18;
% load and normalize the measured spectral data for the patch #1
data = importdata('1.1_real.sp', ' ', cm_h_offset + 1);
real_11 = data.data./100;
data = importdata('1.1_imaged.sp', ' ', cm_h_offset);
imaged_11 = data.data./100;
data = importdata('1.1_matching.sp', ' ', cm_h_offset);
matching_11 = data.data./100;
data = importdata('1.2_real.sp', ' ', cm_h_offset + 1);
real_12 = data.data./100;
data = importdata('1.2_imaged.sp', ' ', cm_h_offset);
imaged_12 = data.data./100;
data = importdata('1.2_matching.sp', ' ', cm_h_offset);
